        ...
        <div className="w-89.5 h-59 pt-4.5 pl-4 space-y-5">
          ...
          <div className="w-86.5 h-16 space-x-5 flex flex-row">
            ...
            <div className="w-33.5 h-13">
              <p className="w-27 h-5 font-noto-serif text-[14px] text-[#9EA3B8]">
                Phone
              </p>
              <p className="w-33.5 h-8 text-white text-[14px] font-inter">
                +234 9033209215
              </p>
            </div>
          </div>
          ...
          <div className="w-86.5 h-25.5 py-5">
            <div className="w-18 h-8">
              <p className="text-[#9EA3B8] font-noto-serif text-[14px]">
                Email
              </p>
            </div>

            <div className="w-48.5 h-5">
              <p className="text-white text-[14px] font-inter">
                info@cuddleysinteriors.com
              </p>
            </div>
          </div>
        </div>
